...
use App\Modules\Esp\Integration\Clients\ActiveCampaign\Requests\ActiveCampaignWebhookEventRequest;
...
final class WebhookEventRequestFactory
{
    public function validateAndMake(NewsletterEspConfig $espConfig, array $data): WebhookEventRequestInterface
    {
        return match ($espConfig->espName) {
            ...
            EspName::ActiveCampaign => ActiveCampaignWebhookEventRequest::validateAndCreate($data),
        };
    }
}
